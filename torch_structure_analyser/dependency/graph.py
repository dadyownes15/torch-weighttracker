...
class DependencyGraph(object):
    def __init__(self):
        ...
        ##  Registration pruners. Not sure why they are here but okay
        ...
        # cache pruning functions for fast lookup: Saving the prunings in the local object, for faster lookup? This is interesting, why would this help in lookup
    ...
    def _trace_computational_graph(self, module2node, output, gradfn2module, reused, visited=set()):
        ...
        def create_node_if_not_exists(grad_fn):
            ...
            """
            A module would be none if: the grad_fn is from a operation such as split, concat etc

            module in module2node: true if it has been added in the traversal. In conjunction with the reuse, because reuse is defined apropirty. 

            module not in reused: the module is only executed once

            Idea: We just add the module2node, 

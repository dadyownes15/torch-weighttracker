...
from .calcs.prunable_bias_param_pr_unit_pr_group import (
    CALCULATION_SPEC as PRUNABLE_BIAS_PARAM_PR_UNIT_PR_GROUP_CALCULATION_SPEC,
)
...
_CALCULATION_SPEC_LIST = (
    ...
    PRUNABLE_BIAS_PARAM_PR_UNIT_PR_GROUP_CALCULATION_SPEC,
